...
export const AddWooCommerceSection: React.VFC<Props> = ({ onClose }) => {
  ...
  return (
    <AddStoreModal storeName={'WooCommerce'} nextPath={AppRoutes.Settings.ConnectStores.Index} onClose={onClose} data={{ url: url, key: key, name: name }}>
      <ListSection>
