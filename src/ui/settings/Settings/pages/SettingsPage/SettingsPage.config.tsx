...
const getSettingsList = (word: WordFunc) => [
  {
    path: {
      ...
      isAdmin: false,
      description: word('settings.general.description')
    },
    get card() {
  ...
  },
  {
    path: {
      ...
      isAdmin: false,
      description: word('settings.connect-stores.description')
    },
    get card() {
  ...
  },
  {
    path: {
      ...
      isAdmin: false,
      description: word('settings.connect-carriers.description')
    },
    get card() {
  ...
  },
  {
    path: {
      ...
      isAdmin: false,
      description: word('settings.delivery-methods.description')
    },
    get card() {
  ...
  },
  {
    path: {
      ...
      isAdmin: true,
      description: word('settings.printing-templates.description')
    },
    get card() {
  ...
  },
  {
    path: {
      ...
      isAdmin: true,
      description: word('settings.email-templates.description')
    },
    get card() {
  ...
  },
  {
    path: {
      ...
      isAdmin: true,
      description: word('settings.printer-and-scales.description')
    },
    get card() {
  ...
  },
  {
    path: {
      ...
      isAdmin: true,
      description: word('settings.customers.description')
    },
    get card() {
  ...
  },
  {
    path: {
      ...
      isAdmin: true,
      userBox: true,
      description: word('settings.users.description')
    },
    get card() {
  ...
  },
  {
    path: {
      ...
      isAdmin: false,
      description: word('settings.link-products.description')
    },
    get card() {
  ...
  },
  {
    path: {
      ...
      isAdmin: true,
      description: word('settings.rules.description')
    },
    get card() {
  ...
  },
  {
    path: {
      ...
      isAdmin: false,
      description: word('settings.billing.description')
    },
    get card() {
      return { icon: <PrinterIcon20 />, ...this.path };
    },
  },
  {
    path: {
      ...
      isAdmin: false,
      description: word('settings.warehouses.description')
    },
    get card() {
      return { icon: <PrinterIcon20 />, ...this.path };
    },
