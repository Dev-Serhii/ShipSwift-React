...
import * as styled from './ParcelforceServiceEditSection.styled';
import { useState } from 'react';
import { useRef } from 'react';
import { addInfoToast, updateToast } from '../../../../../toast';
import { useCourierClient } from '../../../../../../client/client-hook';
import { useAuth0 } from '../../../../../../business/auth/hooks';
import { services } from '../../Step2/ParcelforceServiceSection/ParcelforceServiceSection.config';
...
export const ParcelforceServiceEditSection: React.VFC<Props> = ({ onClose }) => {
