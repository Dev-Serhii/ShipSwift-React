...
import * as styled from './USPSServiceEditSection.styled';
import { services } from './USPSServiceEditSection.config';
...
export const USPSServiceEditSection: React.VFC<Props> = ({ onClose }) => {
