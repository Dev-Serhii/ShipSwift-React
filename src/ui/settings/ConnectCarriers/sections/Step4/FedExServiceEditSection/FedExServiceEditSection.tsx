...
import * as styled from './FedExServiceEditSection.styled';
import { useState } from 'react';
import { useRef } from 'react';
import { addInfoToast, updateToast } from '../../../../../toast';
import { useCourierClient } from '../../../../../../client/client-hook';
import { useAuth0 } from '../../../../../../business/auth/hooks';
import { services } from '../../Step2/FedExServiceSection/FedExServiceSection.config';
...
export const FedExServiceEditSection: React.VFC<Props> = ({ onClose }) => {
