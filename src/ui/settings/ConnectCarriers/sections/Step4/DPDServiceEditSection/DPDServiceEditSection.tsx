...
import * as styled from './DPDServiceEditSection.styled';
import { useState } from 'react';
import { useRef } from 'react';
import { addInfoToast, updateToast } from '../../../../../toast';
import { useCourierClient } from '../../../../../../client/client-hook';
import { useAuth0 } from '../../../../../../business/auth/hooks';
import { services } from '../../Step2/DPDServiceSection/DPDServiceSection.config';
...
export const DPDServiceEditSection: React.VFC<Props> = ({ onClose }) => {
