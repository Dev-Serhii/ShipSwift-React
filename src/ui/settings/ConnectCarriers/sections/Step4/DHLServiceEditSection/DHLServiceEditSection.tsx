...
import * as styled from './DHLServiceEditSection.styled';
...
import { services } from '../../Step2/DHLServiceSection/DHLServiceSection.config';
...
export const DHLServiceEditSection: React.VFC<Props> = ({ onClose }) => {
