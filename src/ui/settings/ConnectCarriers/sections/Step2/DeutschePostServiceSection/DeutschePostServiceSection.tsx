...
import * as styled from './DeutschePostServiceSection.styled';
import { services } from './DeutschePostServiceSection.config';
...
export const DeutschePostServiceSection: React.VFC<Props> = ({ onClose }) => {
