...
import * as styled from './RoyalMailServiceSection.styled';
import { services } from './RoyalMailServiceSection.config';
...
export const RoyalMailServiceSection: React.VFC<Props> = ({ onClose }) => {
