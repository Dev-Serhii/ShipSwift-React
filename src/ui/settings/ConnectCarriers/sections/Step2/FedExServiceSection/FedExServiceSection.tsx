...
import * as styled from './FedExServiceSection.styled';
import { services } from './FedExServiceSection.config';
...
export const FedExServiceSection: React.VFC<Props> = ({ onClose }) => {
