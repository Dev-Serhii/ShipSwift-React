...
import * as styled from './ParcelforceServiceSection.styled';
import { services } from './ParcelforceServiceSection.config';
...
export const ParcelforceServiceSection: React.VFC<Props> = ({ onClose }) => {
