...
import * as styled from './HermesServiceSection.styled';
import { services } from './HermesServiceSection.config';
...
export const HermesServiceSection: React.VFC<Props> = ({ onClose }) => {
