...
import * as styled from './AustraliaPostServiceSection.styled';
import { services } from './AustraliaPostServiceSection.config';
...
export const AustraliaPostServiceSection: React.VFC<Props> = ({ onClose }) => {
