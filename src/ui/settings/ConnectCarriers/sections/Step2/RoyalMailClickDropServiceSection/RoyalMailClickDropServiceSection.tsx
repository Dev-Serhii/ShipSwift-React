...
import * as styled from './RoyalMailClickDropServiceSection.styled';
import { services } from './RoyalMailClickDropServiceSection.config';
...
export const RoyalMailClickDropServiceSection: React.VFC<Props> = ({ onClose }) => {
