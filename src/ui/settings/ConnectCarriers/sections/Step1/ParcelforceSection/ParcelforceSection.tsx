...
import * as styled from './ParcelforceSection.styled';
...
export const ParcelforceSection: React.VFC<Props> = ({ onClose }) => {
      ...
      .then((client) => {
        client.createCarrier({
          ...
          .then((data) => {
            ...
            push(AppRoutes.Settings.ConnectCarriers.Step2.Parcelforce)
          })
          .catch((err) => {
    ...
    >
      <styled.BodyWrapper>
        ...
        <FormCaption caption={word('global.contract.no')}>
          <InputCustom value={contractNumber} onChange={(e) => setContractNumber(e)} />
        </FormCaption>
